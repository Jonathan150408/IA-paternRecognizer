...
namespace IA05_Console.Models.Definitions
{
    ...
    public class NetworkPreview
    {
        ...
        /// </summary>
        public (uint, uint)? GridDimensions { get; set; }

        /// <summary>
        /// Constructor
        /// </summary>
        public NetworkPreview(uint id, string name, string description, string path, bool needForm, (uint, uint)? gridDimensions)
        {
            Id = id;
            Name = name;
